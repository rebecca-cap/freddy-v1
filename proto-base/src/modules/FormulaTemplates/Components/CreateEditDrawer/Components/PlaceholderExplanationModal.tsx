    ...
    <>
      ...
      >
        <Texto category='p2' appearance='medium'>
          ...
          <span style={{ fontFamily: 'monospace', color: '#722ed1', fontWeight: 600 }}>[*INSTR*]</span>) for fields that
          will be customized later when applying this template.
        </Texto>
        <GraviButton
          onClick={() => setPlaceholderModalVisible(true)}
          className='ml-1 ghost-gravi-button'
          buttonText={
            <Texto category='p2' weight={'normal'} style={{ color: '#1890ff', textDecoration: 'underline' }}>
              Tell me more
            </Texto>
          }
        />
      ...
      <Modal
        ...
        footer={[
          <GraviButton key='close' buttonText='Got It' onClick={() => setPlaceholderModalVisible(false)} success />,
        ]}
        width={700}
      >
        <Vertical style={{ gap: '20px' }}>
          <Vertical>
            ...
            <Texto category='p2' appearance='medium'>
              ...
              <span style={{ fontFamily: 'monospace', color: '#722ed1', fontWeight: 600 }}>[*INSTR*]</span> for
              instrument or <span style={{ fontFamily: 'monospace', color: '#722ed1', fontWeight: 600 }}>[*PUB*]</span>{' '}
              for publisher.
            </Texto>
          </Vertical>
          ...
          <Vertical>
            ...
            <div className='border-radius-4 p-2' style={{ backgroundColor: '#fafafa', border: '1px solid #f0f0f0' }}>
              <Vertical style={{ gap: '8px' }}>
                <Horizontal className='gap-10'>
                  <span style={{ fontFamily: 'monospace', color: '#722ed1', fontWeight: 600, minWidth: '120px' }}>
                    [*PCT*]
                  </span>
                  <Texto category='p2' appearance='medium'>
                    Percentage value
          ...
          <div>
            ...
            <div className='p-3 border-radius-4' style={{ backgroundColor: '#f0f5ff', border: '1px solid #d6e4ff' }}>
          ...
          <div>
            ...
            <div className='p-3 border-radius-4' style={{ backgroundColor: '#fafafa', border: '1px solid #f0f0f0' }}>
              <Vertical className='gap-10'>
                <div>
                  ...
                  <Texto category='p2' className='mt-1' style={{ fontFamily: 'monospace', display: 'block' }}>
                    100% <span style={{ color: '#722ed1', fontWeight: 600 }}>[*PUB*]</span>{' '}
                    <span style={{ color: '#722ed1', fontWeight: 600 }}>[*INSTR*]</span> Prior Day Settle
                  </Texto>
                </div>
                <div style={{ borderLeft: '3px solid #1890ff', paddingLeft: '12px' }}>
                  ...
                  <Texto category='p2' className='mt-1' style={{ fontFamily: 'monospace', display: 'block' }}>
                    100% <span style={{ color: '#52c41a', fontWeight: 600 }}>Argus</span>{' '}
                    <span style={{ color: '#52c41a', fontWeight: 600 }}>CBOB USGC</span> Prior Day Settle
                  </Texto>
                </div>
              </Vertical>
            </div>
