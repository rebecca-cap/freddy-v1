...
import { useContractsTyped } from '@modules/ContractManagement/api/useContractsTyped'
...
export function EntityActionMenu(props) {
  ...
  const { cancelContract } = useContractsTyped()
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
      ...
      />
      <Popover
        overlayClassName='entity-action-popover'
