...
function PricingDisplayName(): ColDef {
  return {
    field: 'PricingDisplayText',
    headerName: 'Pricing Display Name',
    cellRenderer: ({ value }) => {
      return (
        <Texto
          style={{
...
function LastModified(): ColDef {
  return {
    ...
    filterValueGetter: ({ data }) => dayjs(data.CreatedDateTime).startOf('day').toDate(),
