            ...
            <Horizontal gap={10} className={'mb-2'} verticalCenter>
              ...
              >
                <TimePicker
                  ...
                  className={'border-radius-5'}
                  disabledTime={() =>
                    createDisabledTimeForDate(getDateForTimeField(window.startTimeName), selectedTimezone)
                  }
                />
              </Form.Item>
            ...
            <Horizontal gap={10} verticalCenter>
              ...
              <Form.Item name={window.endTimeName} rules={[{ required: true, message: 'End time is required' }]}>
                <TimePicker
                  ...
                  className={'border-radius-5'}
                  disabledTime={() =>
                    createDisabledTimeForDate(getDateForTimeField(window.endTimeName), selectedTimezone)
                  }
                />
              </Form.Item>
              {selectedTimezone && <BBDTag style={{ alignSelf: 'center' }}>{selectedTimezone}</BBDTag>}
