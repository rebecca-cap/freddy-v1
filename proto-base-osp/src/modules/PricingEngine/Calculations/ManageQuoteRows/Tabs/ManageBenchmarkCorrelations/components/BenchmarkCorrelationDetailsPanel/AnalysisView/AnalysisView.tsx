...
import { useManageBenchmarkCorrelationsTyped } from '../../../api/useManageBenchmarkCorrelationsTyped'
...
export function AnalysisView({
  ...
  const { useLatestMeasurements } = useManageBenchmarkCorrelationsTyped()
