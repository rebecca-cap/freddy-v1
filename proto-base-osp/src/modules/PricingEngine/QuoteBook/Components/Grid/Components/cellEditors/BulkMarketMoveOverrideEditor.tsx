...
export const BulkMarketMoveOverrideEditor = forwardRef<HTMLDivElement, BulkMarketMoveEditorParams>((props, _ref) => {
  ...
  const replace = (row: Quote) => {
    ...
    return {
      ...
      ProposedPrice: price === false ? row.ProposedPrice : parseFloat(price),
    }
  }
