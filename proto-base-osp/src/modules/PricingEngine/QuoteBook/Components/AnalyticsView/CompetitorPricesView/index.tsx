...
import { useQuoteAnalyticsCompetitorPricesTyped } from '@modules/PricingEngine/QuoteBook/Components/AnalyticsView/CompetitorPricesView/api/useQuoteAnalyticsCompetitorPricesTyped'
...
export function QuoteCompetitorView({
  ...
  const { getCompetitorPricesQuery } = useQuoteAnalyticsCompetitorPricesTyped()
  ...
  return (
    <Vertical className='full-height-width'>
      ...
      <Horizontal className='full-height-width'>
        ...
        <Vertical flex={1} className='m-4' gap='0.5em' style={{ maxWidth: '250px' }}>
