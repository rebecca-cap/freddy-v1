...
export function ChartController({
  ...
  return (
    ...
    >
      <Horizontal className='px-4 pt-2 pb-4' verticalCenter gap={20}>
        <Texto category='h5' style={{ color: CHART_COLORS.labelMuted }}>
          Chart Options
        </Texto>
      </Horizontal>
      ...
      <Horizontal className='px-4 py-1' verticalCenter gap={20}>
