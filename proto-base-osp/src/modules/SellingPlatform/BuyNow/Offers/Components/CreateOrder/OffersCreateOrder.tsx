        ...
        <div style={{ overflowY: 'scroll' }}>
          ...
          {(selectedItemMeta?.IsInternalUser || selectedItemMeta?.SpecialOfferData) && (
            <OrderDates
              ...
              timeZoneAlias={selectedItemMeta?.SpecialOfferData?.TimeZoneAlias}
            />
          )}
          {selectedAdditionalProducts && (
            <div>
              <Horizontal className='mt-3 mx-4 pb-2 justify-sb border-bottom' verticalCenter>
                <Texto category='h5' appearance='default' weight={900}>
                  Additional Products
                </Texto>
          ...
          <Horizontal className='mt-3'>
            <Collapse
              className={'additional-options-collapse'}
              ghost
              style={{ minWidth: '100%' }}
              defaultActiveKey='1'
              items={[
                {
                  ...
                  label: <Texto category='h5'>Additional Options</Texto>,
                  children: (
                    <div>
