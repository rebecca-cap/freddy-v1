...
export const BenchmarkDiffColumn = ({ benchmark, hideBenchmarkDiffColumn, sectionName }) => ({
  ...
  cellStyle: (params) => {
    ...
    if (params.value > 0) style = { color: 'green', fontWeight: 'bold' }
    return style
  },
  valueGetter: (params) => {
    const value =
