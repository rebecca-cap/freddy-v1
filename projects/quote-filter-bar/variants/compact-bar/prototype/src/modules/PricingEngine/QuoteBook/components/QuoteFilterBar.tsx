...
// Variant "Compact Bar": brand-green accent + single-row (no token row).
const C = {
  primary: '#0c7a5a',
  primarySoftBg: '#e7f5f0',
  primarySoftBorder: '#b3ddcd',
  border: '#d1d5db',
  borderLight: '#e5e7eb',
  text: '#111827',
  textMuted: '#6b7280',
...
export function QuoteFilterBar({
  ...
  return (
    ...
    >
      ...
      {/* Compact Bar variant: no separate token row — active state lives in the
          chip/select styling + the inline count, keeping everything on one line. */}
    </div>
  )
}
