...
const makeQuote = (
  ...
  // null = a normal (non-spread) row. The grid hides rows whose
  // SpreadParentMappingId is "defined and not null" when showSpreadRows is
  // off (the default), so 0 here made every row disappear. (was: 0)
