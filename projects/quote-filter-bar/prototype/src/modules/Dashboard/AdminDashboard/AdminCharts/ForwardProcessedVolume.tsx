...
export function ForwardProcessedVolume({ strokeColor, chartFilters, onFiltersChange, selectOptions }) {
  ...
  if (isFetching) {
    return (
      <Horizontal className='bg-1' verticalCenter horizontalCenter style={{ height: '33vh' }}>
        <Texto category='h3'>
          <LoadingOutlined />
        </Texto>
      </Horizontal>
      ...
      <Vertical>
        ...
        {!!chartData?.length && (
          <>
            ...
            <Horizontal fullHeight horizontalCenter verticalCenter style={{ height: '33vh' }}>
              <ResponsiveContainer>
                <BarChart
                  layout='vertical'
                  data={chartData}
        ...
        {!chartData?.length && (
          <Horizontal className='bg-3 m-4 p-4' fullHeight horizontalCenter verticalCenter style={{ height: '33vh' }}>
            <NothingMessage
              title='No data found'
