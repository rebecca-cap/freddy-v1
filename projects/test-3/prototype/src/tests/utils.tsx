...
import { AuthProvider } from '@gravitate-js/excalibrr'
...
export const renderWithMockedAPI = (component) => {
  ...
  return render(
    <AuthProvider baseUrl='http://core-internal.fay-devsolver1.fay.cap/api'>
