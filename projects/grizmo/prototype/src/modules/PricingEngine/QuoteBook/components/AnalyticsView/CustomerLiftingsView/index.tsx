...
import { useQuoteAnalyticsCustomerLiftings } from '@modules/PricingEngine/QuoteBook/components/AnalyticsView/CustomerLiftingsView/api/useQuoteAnalyticsCustomerLiftings'
...
export function CustomerLiftingsView({ quoteRowId, fromDate, toDate }: CustomerLiftingsViewProps) {
  ...
  const { useQuoteAnalyticsLiftings } = useQuoteAnalyticsCustomerLiftings()
