import { useQuoteBookAnalytics } from '@api/useQuoteBookAnalytics'
...
function LiftingVsBenchmarkView({ quoteRowId, fromDate, toDate, selectedRow }: LiftingVsBenchmarkViewProps) {
  ...
  const { useQuoteAnalyticsLiftingVsBenchmark } = useQuoteBookAnalytics()
  ...
  return (
    <Horizontal fullHeight style={{ gap: '1rem' }} className='p-4'>
