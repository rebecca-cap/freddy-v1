...
export const initialScoutState: ScoutState = {
    ...
    items: [
      {
        ...
        description:
          'Pulls margin health, peer comparison, and 30-day trend for the active row.',
        steps: [
          { id: 'mc-1', label: 'Why this margin?' },
          { id: 'mc-2', label: 'Margin vs peer median' },
          { id: 'mc-3', label: '30-day margin trend' },
        ],
        scope: 'row',
        starred: false,
        kind: 'path',
      ...
      },
      {
        ...
        name: 'Explain this price',
        description:
          'One-shot explanation of why the proposed price is where it is — drivers + benchmarks.',
        steps: [
  ...
  activity: [
    {
      id: 'act-1',
      title: 'Why is Casey’s margin tightening?',
      description:
        'Spot benchmark moved up $0.0040/gal; our proposed price held; margin compressed $0.0008/gal over 7 days.',
      when: _now - 3 * MIN,
      rowIds: [],
      source: 'seed',
    },
    {
      id: 'act-2',
      title: 'Compare Pilot Flying J vs peer median',
      description:
        'Pilot proposed at $2.6620/gal vs peer median $2.6505/gal — running $0.0115/gal above the band.',
      when: _now - 22 * MIN,
      rowIds: [],
      source: 'seed',
    },
    {
      id: 'act-3',
      title: 'Summarize today’s flagged rows',
      description:
        '7 flagged rows: 4 margin guard, 2 stale benchmark, 1 above peer band.',
      when: _now - 90 * MIN,
      rowIds: [],
      source: 'seed',
    },
