...
const CHIP: Record<string, Chip> = {
  'agg-flagged': { id: 'agg-flagged', label: 'Why are these rack rows flagged?', promptId: 'agg-flagged' },
  'agg-top': { id: 'agg-top', label: 'Where am I leaving margin on the rack?', promptId: 'agg-top' },
  'agg-move': { id: 'agg-move', label: "How did today's rack market move?", promptId: 'agg-move' },
  'agg-unpub': { id: 'agg-unpub', label: 'Why are these rack rows unpublished?', promptId: 'agg-unpub' },
  ...
  'agg-terminal-arbs': { id: 'agg-terminal-arbs', label: 'Analyze terminal arb relationships across selected rows', promptId: 'agg-terminal-arbs' },
  'bench-why': { id: 'bench-why', label: 'Why this cost?', promptId: 'bench-why' },
  'bench-fresh': { id: 'bench-fresh', label: 'How fresh is the OPIS rack print?', promptId: 'bench-fresh' },
  'bench-trend': { id: 'bench-trend', label: '7-day OPIS rack trend', promptId: 'bench-trend' },
  'prop-why': { id: 'prop-why', label: 'Why this proposed post?', promptId: 'prop-why' },
  'prop-whatif': { id: 'prop-whatif', label: 'What if I lift the post $0.0050/gal?', promptId: 'prop-whatif' },
  'marg-trend': { id: 'marg-trend', label: '30-day margin trend', promptId: 'marg-trend' },
}

const AGGREGATE_CHIPS = ['agg-flagged', 'agg-top', 'agg-move', 'agg-sinclair-opis-rank', 'agg-terminal-arbs']
