...
export const initialScoutState: ScoutState = {
    ...
    items: [
      {
        ...
        name: 'Denver–N Platte arb check',
        description:
          'Walks the Denver-vs-N Platte ULSD spread, the share-holding spread band, and which customers are switching.',
        steps: [
          { id: 'mc-1', label: 'Is Denver losing volume to N Platte?' },
          { id: 'mc-2', label: 'What spread holds 90% Denver share?' },
          { id: 'mc-3', label: 'Which customers are switching?' },
        ],
        scope: 'agg',
        starred: true,
        kind: 'path',
      ...
      },
      {
        ...
        name: 'Triage wide-spread rack rows',
        description:
          'Walks every wide rack spread, compares peer terminal posts, and suggests a next action.',
        steps: [
          { id: 'fr-1', label: 'Which rack spreads exceed $0.40?' },
          { id: 'fr-2', label: 'How do peer terminals post this?' },
      ...
      },
      {
        ...
        name: 'Explain this rack post',
        description:
          'One-shot explanation of why the proposed rack post is where it is — drivers + OPIS rack band.',
        steps: [
          { id: 'ep-1', label: 'Explain this rack post', promptId: 'prop-why' },
        ],
        scope: 'row',
        starred: false,
        kind: 'prompt',
      ...
      },
      {
        ...
        name: 'What if I lift the post $0.0050/gal?',
        description:
          'Models the lift impact against the Denver–N Platte substitution curve on the active rack row.',
        steps: [
          {
            id: 'wim-1',
            label: 'What if I lift the post $0.0050/gal?',
  ...
  activity: [
    {
      id: 'act-1',
      title: 'Is Denver bleeding ULSD volume to N Platte?',
      description:
        'Spread held at +$0.33/gal (median); Denver kept ~79% of combined #2 ULSD volume over the window.',
      when: _now - 3 * MIN,
      rowIds: [],
      source: 'seed',
    },
    {
      id: 'act-2',
      title: 'What spread should I hold Denver at?',
      description:
        'Keep Denver ≤ $0.25/gal above N Platte to hold ~90% share; above $0.40/gal share collapses to ~45%.',
      when: _now - 22 * MIN,
      rowIds: [],
      source: 'seed',
    },
    {
      id: 'act-3',
      title: 'Which customers switch between Denver and N Platte?',
      description:
        'BRAD HALL & ASSOC and MUSKET CORP are the true switchers; OFFEN and TARTAN are effectively single-terminal.',
      when: _now - 90 * MIN,
      rowIds: [],
      source: 'seed',
    },
