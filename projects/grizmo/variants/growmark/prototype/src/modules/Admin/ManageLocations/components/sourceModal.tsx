...
export function SourceModal({ isModalOpen, handleModalCancel, form, handleSourceModalSave, editingRow, metadata }) {
  return (
    <Modal
      visible={isModalOpen}
      title='Edit Source Id'
      footer={[
        <GraviButton buttonText='Cancel' onClick={handleModalCancel} />,
...
function SourceEditorModal({ metadata, editingRow, onFinish, form }) {
  useEffect(() => {
