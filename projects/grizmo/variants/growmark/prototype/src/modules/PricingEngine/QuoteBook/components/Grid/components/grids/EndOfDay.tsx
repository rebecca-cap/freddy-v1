...
import { useScoutGridWiring } from '@modules/Scout/grid/useScoutGridWiring'
...
export function EndOfDay({
  ...
  const columnDefs = (useScoutGridWiring(baseColumnDefs, gridRef) ?? baseColumnDefs) as typeof baseColumnDefs
