...
const Margin = () => ({
  ...
  cellStyle: (params) => {
    ...
    if (params.value < 0) style.backgroundColor = 'var(--theme-error-dim)'
    if (params.value > 0) style.backgroundColor = 'var(--theme-success-dim)'
    return style
  },
})
  ...
  children: [
    {
      ...
      valueGetter: (params) => params?.data?.ProposedPrice - params?.data?.PriorQuotePeriod?.LastPrice,
