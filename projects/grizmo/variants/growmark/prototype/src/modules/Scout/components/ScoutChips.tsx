...
const CHIP: Record<string, Chip> = {
  'agg-flagged': { id: 'agg-flagged', label: 'Why are 14 rows flagged?', promptId: 'agg-flagged' },
  'agg-top': { id: 'agg-top', label: 'Where can I tighten cost tracking?', promptId: 'agg-top' },
  'agg-move': { id: 'agg-move', label: "How did today's OPIS Low 6 PM move affect cost?", promptId: 'agg-move' },
  'agg-unpub': { id: 'agg-unpub', label: 'Why are these rows unpublished?', promptId: 'agg-unpub' },
  'agg-sinclair-opis-rank': { id: 'agg-sinclair-opis-rank', label: 'How does our Cost track OPIS Low 6 PM?', promptId: 'agg-sinclair-opis-rank' },
  ...
  'bench-trend': { id: 'bench-trend', label: '7-day OPIS Low 6 PM trend', promptId: 'bench-trend' },
  'prop-why': { id: 'prop-why', label: 'Why this published price?', promptId: 'prop-why' },
  'prop-whatif': { id: 'prop-whatif', label: 'What if I raise the Adjustment $0.0050/gal?', promptId: 'prop-whatif' },
  'marg-trend': { id: 'marg-trend', label: '7-day price vs cost', promptId: 'marg-trend' },
}
