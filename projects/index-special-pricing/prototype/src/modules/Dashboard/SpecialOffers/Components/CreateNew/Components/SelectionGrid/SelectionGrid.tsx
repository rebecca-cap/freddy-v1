...
export interface CustomerSelectGridProps {
  ...
  storageKey: string
  /** When embedded in a form (e.g. quick-create), pass false to hide the AG-Grid side tool panel. */
  sideBar?: boolean
  /** Wrapper height. Defaults to 400px; pass a smaller value to right-size an embedded grid. */
  ...
  return (
    <div style={{ height }}>
      <GraviGrid
        ...
        // Only forward when explicitly set so existing callers keep their default sidebar.
