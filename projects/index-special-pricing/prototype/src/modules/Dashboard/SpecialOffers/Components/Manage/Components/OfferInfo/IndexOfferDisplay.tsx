...
export function IndexOfferDisplay({ indexDisplay, isAuction }: IndexOfferDisplayProps) {
  ...
  return (
    <>
      <Horizontal className={'mt-4'}>
        <Texto category={'h5'}>Pricing</Texto>
      </Horizontal>

      <Horizontal className={'created-by-container'}>
        <Texto>{indexDisplay.PricingDisplayText}</Texto>
      </Horizontal>
                ...
                ? () => (
                    <div style={{ display: 'flex' }}>
                      <Texto weight='bold'>
                        ...
                        {isAuction
                          ? 'Bid'
                          : contractDifferential.Value != null
                          ? fmt.currency(contractDifferential.Value)
                          : '—'}
                      </Texto>
                    </div>
                  )
