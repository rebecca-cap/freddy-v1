...
import { QuickCreateSpecialOffer } from '@modules/Dashboard/SpecialOffers/Components/QuickCreate/QuickCreateSpecialOffer'
...
export function SpecialOffersPage() {
  ...
  const [isShowingQuickCreate, setIsShowingQuickCreate] = useState(false)
  ...
  return (
    <div style={{ height: '99%', width: '100%' }}>
      <SpecialOffersGrid
        ...
        onQuickCreate={() => setIsShowingQuickCreate(true)}
        onOpenOffer={handleOpenOffer}
        onCreateFromPrior={handleCreateFromPrior}
        canWrite={canWrite}
        metadata={metadata?.Data}
      />
      <QuickCreateSpecialOffer
        isOpen={isShowingQuickCreate}
        onClose={() => setIsShowingQuickCreate(false)}
        metadata={metadata?.Data}
      />
