...
import { updateRowPricingDataOnValueChange } from '@modules/PricingEngine/QuoteBook/Components/Grid/Components/columns/helpers'
...
const Margin = () => ({
  ...
  valueGetter: (params) => {
    ...
    const proposedPrice = isSpreadRow(params)
      ? params?.data?.StrategyBase?.Value + adjustmentValue
      : params?.data?.ProposedPrice
