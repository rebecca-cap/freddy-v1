...
interface FormulaTemplateChooserProps {
  ...
  /** Optional seed for the filter state (e.g. pre-narrow to the selected product). Defaults to no filters. */
  initialFilters?: FormulaTemplateFilter
}
...
export function FormulaTemplateSelector({
  ...
  const [filters, setFilters] = useState<FormulaTemplateFilter>(initialFiltersProp ?? initialFilters)
  return (
